...
種構成（Phase 11 で確定, CLAUDE.md参照）:
  被食者(x): マアジ x1, ウルメイワシ x2  （小型浮魚, マアジはマイワシから置換）
  捕食者(y): ブリ y1, サワラ y2            （大型魚食魚）

被食者(マアジ・ウルメ)の生物量は捕食者(ブリ・サワラ)より大きく、
...
_REG = {
    "マアジ": dict(
        file="マアジ時系列データ_資源量・漁獲量・漁獲係数_FRA資源評価2025.csv",
        yr="年", bio="資源量（千トン）", catch="漁獲量（千トン）",
...
ASSIGN = {"x1": "マアジ", "x2": "ウルメイワシ", "y1": "ブリ", "y2": "サワラ"}
SPECIES_LABELS = ["マアジ (x1)", "ウルメイワシ (x2)", "ブリ (y1)", "サワラ (y2)"]
KEYS = ["x1", "x2", "y1", "y2"]
