...
fig.suptitle("【制約推定】マイワシ+ウルメ / ブリ+サワラ — Catch-MSY確定値固定(r_x1,r_x2,c1+d1,c2+d2)", fontsize=14, y=1.003)
plt.tight_layout()
out = os.path.join(_out_dir, "fit_制約_マイワシ_ウルメイワシ_ブリ_サワラ_capacity_ry_constrained.png")
